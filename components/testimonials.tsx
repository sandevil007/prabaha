      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              <SwiperSlide>
                <div className="flex flex-col items-center justify-center p-5 bg-gray-800 min-h-[650px]" data-aos="fade-up">
                  <div>
                    ...
                    <blockquote className="text-lg text-gray-400 text-center grow">I have boarded my pup for 3 days with Prabaha. Sayantan listened to all details carefully and took care of him. He sent regular updates and videos. If you are looking for a good place for boarding or training, I would recommend Prabaha.</blockquote>
                    <div className="text-gray-700 font-medium mt-6 mb-10 pt-5 border-t border-gray-700 w-full text-center">
              ...
              <SwiperSlide>
                <div className="flex flex-col items-center justify-center p-5 bg-gray-800 min-h-[650px]">
                  <div>
                    <div className="flex flex-col items-center mb-4">
              ...
              <SwiperSlide>
                <div className="flex flex-col items-center justify-center p-5 bg-gray-800 min-h-[650px]">
                  <div>
                    ...
                    <blockquote className="text-lg text-gray-400 text-center grow">Awesome place for dog training! The trainers really know their stuff and my dog loves going here. They teach cool tricks and also work on obedience. Totally worth the money and time. 5/5, would recommend!</blockquote>
                    <div className="text-gray-700 font-medium mt-6 mb-10 pt-5 border-t border-gray-700 w-full text-center">
              ...
              <SwiperSlide>
                <div className="flex flex-col items-center justify-center p-5 bg-gray-800 min-h-[650px]">
                  <div>
                    ...
                    <blockquote className="text-lg text-gray-400 text-center grow">Prabaha was awesome for me and my doggo. He taught us how to get along better and play cool games. My doggo is now a good boy, a friendly boy, and a happy boy.</blockquote>
                    <div className="text-gray-700 font-medium mt-6 mb-10 pt-5 border-t border-gray-700 w-full text-center">
